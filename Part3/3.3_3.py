...
Примечание 2. Гарантируется, что до полудня и после полудня совершено
различное количество покупок.
'''
...
before = len(list((filter(lambda dt: dt.hour < 12, times_of_purchases))))

if len(times_of_purchases) - before > 0:
    print('После полудня')
else:
    print('До полудня')