...
Обе функции должны принимать один необязательный аргумент reverse, по умолчанию равный False, который
...
Например, если в словарь data будет добавлена новая пара ключ-значение, то и в возвращаемых функциями списках данные
...
[2014, 2013, 2011, 2011, 2010, 2010, 2008, 2008, 2007, 2006, 2006, 2006, 2006, 2005, 2004, 2004, 2004, 2004, 2
003, 2001, 2001, 2000, 1999, 1999, 1997, 1994, 1990]
...
# Лямбда-выражение, которое получает аргумент по умолчанию reverse=False
