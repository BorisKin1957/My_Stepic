...
Напишите программу, которая принимает на вход последовательность дат и выводит
их в порядке неубывания.

Формат входных данных
На вход программе подается натуральное число nn, а затем nn корректных дат в ISO
...
for _ in range(int(input())):
    ...
    l_out.append(my_d)
print(*[i.strftime('%d/%m/%Y') for i in sorted(l_out)], sep='\n')