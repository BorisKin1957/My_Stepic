...
указав для каждого количество файлов с данным расширением. Расширения должны быть расположены
...
l = []
for mail in files:
    l.append(mail.split('.')[1])
ext_dict = Counter(l)
ext_dict = sorted(ext_dict.items(), key=lambda x: x[0])
