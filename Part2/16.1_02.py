...
Функция должна получать на вход один обязательный аргумент data –
список, который следует вывести и два необязательных строковых односимвольных
...
def pretty_print(our_l, side='-', delimiter='|'):
    s = delimiter
    for i in our_l:
        s += ' ' + str(i) + ' ' + delimiter
    line = ' ' + side * (len(s) - 2)
