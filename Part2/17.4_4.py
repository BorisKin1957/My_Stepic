...
Оценка - целое число от 00 до 100100 включительно.

Напишите программу для добавления 55 баллов к каждому результату теста и
...
with open('class_scores.txt', encoding='utf-8') as f1, open('new_scores.txt', 'w', encoding='utf-8') as f2:
    for line in f1:
        l = line.strip().split()
        if int(l[1]) > 95:
            print(l[0], 100, file=f2)
        else:
            print(l[0], int(l[1]) + 5, file=f2)