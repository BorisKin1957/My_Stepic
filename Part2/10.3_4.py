...
s = 'orange strawberry barley gooseberry apple apricot barley ' \
    ...
    'currant gooseberry raspberry apricot currant orange lime ' \
    'quince grapefruit barley banana melon pomegranate barley banana ' \
    'orange barley apricot plum banana quince lime grapefruit strawberry ' \
    'gooseberry apple barley apricot currant orange melon pomegranate ' \
    'banana banana orange apricot barley plum banana grapefruit banana ' \
    'quince currant orange melon pomegranate barley plum banana quince ' \
...
for key in l:
    if l.count(key) > a:
        result = {}
        result[key] = l.count(key)
        a = l.count(key)
    elif l.count(key) == a and key not in result:
        result[key] = a
