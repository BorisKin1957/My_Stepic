...
Напишите программу сортировки по убыванию списка data на основании последнего символа
в названии штата. Затем распечатайте элементы этого списка, каждый на новой строке в формате:
...
по убыванию на основании последнего символа в названии штата. При этом,
если два штата имеют одинаковый последний символ, следует сохранить их взаиморасположение в начальном списке.
...
for i_tuple in sorted_data:
        print(f'{i_tuple[1]}: {i_tuple[0]}')

'''ЛУЧШЕ ТАК

sorted_data = sorted(data, key=lambda city: city[1][-1], reverse=True)

for pop, city in sorted_data:
        print(f'{city}: {pop}')
